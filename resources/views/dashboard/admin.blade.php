                    ...
                    <div class="card-body p-0">
                        <div class="flex flex-wrap items-center justify-between gap-1 mb-2">
                            <div class="flex items-center gap-2">
                                ...
                                <div>
                                    <span class="mb-2 font-medium text-secondary-light text-sm">{{ __('Paid Customers') }}</span>
                                    <h6 class="font-semibold">{{ $user['total_paid_user'] }}</h6>
                                </div>
                            </div>

                            <div id="new-user-chart" class="remove-tooltip-title rounded-tooltip-value"></div>
                        </div>
                        <p class="text-sm mb-0">Total  <span class="bg-success-100 dark:bg-success-600/25 px-1 py-px rounded font-medium text-success-600 dark:text-success-400 text-sm">{{ $user->total_user }}</span> {{ __('Total Customers') }}</p>
                    </div>
                </div>
                    ...
                    <div class="card-body p-0">
                        <div class="flex flex-wrap items-center justify-between gap-1 mb-2">
                            <div class="flex items-center gap-2">
                                ...
                                <div>
                                    <span class="mb-2 font-medium text-secondary-light text-sm">{{ __('Total Orders') }}</span>
                                    <h6 class="font-semibold">{{ super_currency_format_with_sym($user['total_orders_price']) }}</h6>
                                </div>
                            </div>

                            <div id="active-user-chart" class="remove-tooltip-title rounded-tooltip-value"></div>
                        </div>
                        <p class="text-sm mb-0">Total  <span class="bg-success-100 dark:bg-success-600/25 px-1 py-px rounded font-medium text-success-600 dark:text-success-400 text-sm">{{ $user->total_orders }}</span> orders</p>
                    </div>
                </div>
                    ...
                    <div class="card-body p-0">
                        <div class="flex flex-wrap items-center justify-between gap-1 mb-2">
                            <div class="flex items-center gap-2">
                                ...
                                <div>
                                    <span class="mb-2 font-medium text-secondary-light text-sm">{{ __('Popular Plan') }}</span>
                                    <h6 class="font-semibold">{{ !empty($user->popular_plan) ? 'Plan ' . $user->popular_plan->name : 'None' }}</h6>
                                </div>
                            </div>

                            <div id="total-sales-chart" class="remove-tooltip-title rounded-tooltip-value"></div>
                        </div>
                        <p class="text-sm mb-0">{{ __('Total Plans') }}  <span class="bg-danger-100 dark:bg-danger-600/25 px-1 py-px rounded font-medium text-danger-600 dark:text-danger-400 text-sm">{{ $user->total_plans }}</span> </p>
                    </div>
                </div>
